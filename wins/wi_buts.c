                    ...
                    int *colwidth)
{
    ...
    for (s = options, *xs = b->b.xsize - d_xsize; s < &options[num_options];
         s++) {
        if (*xs < ws_pixstrlen(*s) + 10) {
            *xs = ws_pixstrlen(*s) + 10;
        }
    }
...
int wi_drawbutton(struct wi_button *b, int highlighted) {
    ...
    if ( !b->sys_button && ( b->b.xpos < 0 || b->b.ypos < 0 || b->b.xsize < 0
                           || b->b.ysize < 0 || b->b.xpos + b->b.xsize >
                            w_xwininsize(b->b.w)
                           || b->b.ypos + b->b.ysize >
                            w_ywininsize(b->b.w) ) ) {
        fprintf( errf, "Button not in window: %d %d %d %d / %d %d\n",
                b->b.xpos, b->b.ypos, b->b.xsize, b->b.ysize,
                w_xwininsize(b->b.w),
                w_ywininsize(b->b.w) );
        return 0;
    ...
    if (notes.cur_but && highlighted == 0 && notes.cur_but->d.w_b == b) {
        highlighted = 3;
    }
    ...
    switch (b->b.type) {
        ...
        case w_b_drag:
            ws_drawframedbox(w_xwinincoord(b->b.w, b->b.xpos),
                             w_ywinincoord(b->b.w,
                                           b->b.ypos), b->b.xsize, b->b.ysize,
                             1,
                             notes.colindex[highlighted == 1 ? cv_buttonrb :
                                            (b->sys_button &&
                                             (struct wi_window *)b->b.w ==
                                             notes.cur_win ?
        ...
        case w_b_switch:
            ...
            ws_drawframedbox(w_xwinincoord(b->b.w, b->b.xpos) + 2,
                             w_ywinincoord(b->b.w,
                                           b->b.ypos) + 2, b->b.xsize - 4,
                             b->b.ysize - 4, 1,
                             notes.colindex[b->b.d.s->on ? cv_buttonrb :
                                            cv_buttonlt],
                             notes.colindex[b->b.d.s->on ? cv_buttonlt :
                                            cv_buttonrb],
                             notes.colindex[highlighted ==
                                            1 ? cv_buttonpressed : (b->b.d.s
                                                                    ->on ?
                                                                    cv_switchon
                                                                    :
                                                                    cv_buttonin)
        ...
        case w_b_choose:
            ...
            ws_drawframedbox(w_xwinincoord(b->b.w,
                                           b->b.xpos) + 1 +
                             b->b.d.ls->d_xsize,
                             w_ywinincoord(b->b.w,
                                           b->b.ypos) + 2, b->b.xsize - 4 -
                             ...
                             b->b.ysize - 4, 1,
                             notes.colindex[highlighted ==
                                            1 ? cv_buttonrb : cv_buttonlt],
                             notes.colindex[highlighted ==
                                            1 ? cv_buttonlt : cv_buttonrb],
                             notes.colindex[cv_buttonin]);

            if (b->b.d.ls->selected >= 0) {
                ws_drawtext(w_xwinincoord(b->b.w,
                                          b->b.xpos) + 4 + b->b.d.ls->d_xsize,
                            w_ywinincoord(b->b.w,
                                          b->b.ypos) + 4, b->b.xsize -
                            b->b.d.ls->d_xsize - 6,
                            b->b.d.ls->options[b->b.d.ls->selected],
                            notes.colindex[highlighted ==
                                           1 ? cv_textfg : cv_textbg],
                            notes.colindex[cv_buttonin]);
                ws_drawtext(w_xwinincoord(b->b.w,
                                          b->b.xpos) + 3 + b->b.d.ls->d_xsize,
                            w_ywinincoord(b->b.w,
                                          b->b.ypos) + 3, b->b.xsize -
                            b->b.d.ls->d_xsize - 6,
                            b->b.d.ls->options[b->b.d.ls->selected],
                            notes.colindex[highlighted ==
                                           1 ? cv_textbg : cv_textfg], -1);
            }

            if (highlighted == 1) {
                columns = wi_choosecoords(b, &xp, &yp, &xs, &ys, &collength,
                                          &colwidth);
                checkmem( b->bm = ws_savebitmap(NULL, xp, yp, xs, ys) );
                ws_drawframedbox(xp, yp, xs, ys, 2,
                                 notes.colindex[cv_buttonlt],
                                 notes.colindex[cv_buttonrb],
                                 notes.colindex[cv_buttonin]);
                ...
                for (s = b->b.d.ls->options, x = 0, y = -1;
                    ...
                    ws_drawtext(xp + x + 5, yp + y * shapes.titlebar_height +
                                4, colwidth - 7, *s,
                                notes.colindex[cv_textbg],
                                notes.colindex[cv_buttonin]);
                    ws_drawtext(xp + x + 4, yp + y * shapes.titlebar_height +
                                3, colwidth - 6, *s,
                                notes.colindex[cv_textfg],
                                -1);
                }
            }
            else {
        ...
        case w_b_tag:
            ...
            if (highlighted == 2) {
                ...
                for (i = 0, x = 0, y = -1; i < b->b.d.tag->num_options;
                     i++) {
                    if (++y >= collength) {
                        y = 0;
                        x += colwidth;
                    ...
                    if (b->b.d.tag->tagged[i]) {
                        ws_drawframedbox(
                            xp + x + 1, yp + y *
                            (shapes.titlebar_height + 2) + 3, colwidth - 4,
                            shapes.titlebar_height + 2, 1,
                            notes.colindex[cv_buttonrb],
                            notes.colindex[cv_buttonlt],
                            notes.colindex[cv_buttonin]);
                    }
                        ...
                        ws_drawfilledbox(
                            xp + x + 1, yp + y *
                            (shapes.titlebar_height + 2) + 3, colwidth - 4,
                            shapes.titlebar_height + 2,
                            notes.colindex[cv_buttonin], 0);
                    }

                    ws_drawtext(xp + x + 5, yp + y *
                                (shapes.titlebar_height + 2) + 5,
                                colwidth - 7, b->b.d.tag->options[i],
                                notes.colindex[b->b.d.tag->tagged[i] ?
                                               cv_textfg :
                                               cv_textbg],
                                notes.colindex[cv_buttonin]);
                    ws_drawtext(
        ...
        case w_b_string:
            ...
            if (strlen(&b->b.d.str->str[b->b.d.str->offset]) >
                b->b.d.str->length) {
                strncpy(buffer, &b->b.d.str->str[b->b.d.str->offset],
                        b->b.d.str->length);
                buffer[b->b.d.str->length] = 0;
            }
            else {
                strcpy(buffer, &b->b.d.str->str[b->b.d.str->offset]);
            }

            ws_drawtext(w_xwinincoord(b->b.w,
                                      b->b.xpos) + 4 + b->b.d.str->d_xsize,
                        w_ywinincoord(b->b.w, b->b.ypos) + 4, b->b.xsize - 6,
                        buffer, notes.colindex[cv_textfg],
                        notes.colindex[cv_bg]);
        ...
        case w_b_list:
            ...
            for (i = 0; i <= (b->b.ysize - 4) / (shapes.titlebar_height + 2)
                ...
                xp =
                    ( (b->b.d.sls->sel_arr[i + b->b.d.sls->start_no] & 1) !=
                     0 );
                ...
                if (xp) {
                    ws_drawframedbox(w_xwinincoord(b->b.w, b->b.xpos) + 2,
                                     w_ywinincoord(b->b.w,
                                                   b->b.ypos) +
                                     (shapes.titlebar_height + 2) * i + 1,
                                     b->b.xsize - 4, shapes.titlebar_height +
                                     1, 1, notes.colindex[cv_buttonrb],
                                     notes.colindex[cv_buttonlt],
                                     notes.colindex[cv_buttonin]);
                }

                if (notes.cur_but && highlighted == 1 &&
                    notes.cur_but->d.w_b == b
                   && (b->b.d.sls->sel_arr[i + b->b.d.sls->start_no] & 2) !=
                    0) {
                    ws_drawbox(w_xwinincoord(b->b.w, b->b.xpos) + 1,
                               w_ywinincoord(b->b.w,
                                             b->b.ypos) +
                ...
                ws_drawtext(w_xwinincoord(b->b.w, b->b.xpos) + 4,
                            w_ywinincoord(b->b.w,
                                          b->b.ypos) +
                            (shapes.titlebar_height + 2) * i + 3,
                            b->b.xsize - 6,
                            b->b.d.sls->strings[i + b->b.d.sls->start_no],
                            notes.colindex[xp ? cv_textfg : cv_textbg],
                            notes.colindex[cv_buttonin]);
                ws_drawtext(w_xwinincoord(b->b.w, b->b.xpos) + 3,
                            w_ywinincoord(b->b.w,
                                          b->b.ypos) +
                            (shapes.titlebar_height + 2) * i + 2,
                            b->b.xsize - 6,
                            b->b.d.sls->strings[i + b->b.d.sls->start_no],
    ...
    for (n = highlighted ==
             1 ? b->b.a_inscription.head : b->b.inscription.head;
         n->next != NULL; n = n->next) {
        switch (n->d.w_d->type) {
            case w_bdt_txt:
                ws_drawtext(w_xwinincoord(b->b.w,
                                          b->b.xpos) + n->d.w_d->x + 1,
                            w_ywinincoord(b->b.w,
                                          b->b.ypos) + n->d.w_d->y + 1,
                            b->b.xsize,
                            n->d.w_d->contents.txt,
                            notes.colindex[highlighted ==
                                           1 ? cv_textfg : cv_textbg], -1);
            ...
            case w_bdt_image:
                ws_copybitmap(NULL, w_xwinincoord(b->b.w,
                                                  b->b.xpos) + n->d.w_d->x,
                              w_ywinincoord(b->b.w,
                                            b->b.ypos) + n->d.w_d->y,
                              n->d.w_d->contents.bm,
                              0, 0, n->d.w_d->contents.bm->xsize,
                              n->d.w_d->contents.bm->ysize,
...
int wi_b_press(struct ws_event *ws, struct wi_button *b) {
    ...
    do {
        ...
        if ( b->b.type == w_b_press &&
            ( ( (b->b.d.p->l_pressed_routine != NULL
                && ws->buttons == ws_bt_left) ||
               (b->b.d.p->r_pressed_routine != NULL
               &&
                ws->buttons == ws_bt_right) )
            && (t2 -
                t1) * 100 >= CLOCKS_PER_SEC *
             (delay ? b->b.d.p->delay : b->b.d.p->repeat)
            && (delay || b->b.d.p->repeat >=
                0) ) ) {
            if (ws->buttons == ws_bt_left) {
                b->b.d.p->l_pressed_routine(&b->b);
            }
            else {
                b->b.d.p->r_pressed_routine(&b->b);
            }
    ...
    if (b->b.type == w_b_press) {
        if (ws->flags == ws_f_lbutton && b->b.d.p->l_routine) {
            b->b.d.p->l_routine(&b->b);
        }
        ...
        if (ws->flags == ws_f_lbutton && b->b.d.s->l_routine) {
            b->b.d.s->l_routine(&b->b);
        }
...
int wi_b_choose(struct ws_event *ws, struct wi_button *b) {
    ...
    do {
        if (i >= 0 && i < b->b.d.ls->num_options && i != oldi && ws->x >
            xp && ws->x < xp + xs) {
            if (oldi >= 0) {
                ws_drawfilledbox(oldx, oldy, cxs - 5,
                                 shapes.titlebar_height + 2,
                                 notes.colindex[cv_buttonin],
                                 0);
                ws_drawtext(oldx + 3, oldy + 2, cxs - 8,
                            b->b.d.ls->options[oldi],
                            notes.colindex[cv_textbg],
                            notes.colindex[cv_buttonin]);
                ws_drawtext(oldx + 2, oldy + 1, cxs - 7,
                            b->b.d.ls->options[oldi],
            ...
            ws_drawframedbox(oldx, oldy, cxs - 5, shapes.titlebar_height + 1,
                             1,
                             notes.colindex[cv_buttonrb],
                             notes.colindex[cv_buttonlt],
                             notes.colindex[cv_buttonin]);
        ...
        i = (ws->y >= yp + 3) && (ws->x >= xp + 3) ?
            ( (ws->x - xp -
               3) /
             cxs ) * collength +
            (ws->y - yp - 3) / shapes.titlebar_height : -1;
    } while (ws->buttons != ws_bt_none);

    if (ws->x > xp && ws->x < xp + xs && i >= 0 && i <
        b->b.d.ls->num_options) {
        b->b.d.ls->selected = i;
    }
...
int wi_b_tag(struct ws_event *ws, struct wi_button *b) {
    int pos, oldpos, leftright, xp, yp, xs, ys, num_selected, cxs, collength,
        cols;
    ...
    } while (xp > b->b.xpos && xp < b->b.xpos + b->b.xsize - 1 && yp >
             b->b.ypos
    ...
    do {
        ...
        pos = (ws->y >= yp + 3) && (ws->x >= xp + 3) ?
              ( (ws->x - xp -
                 3) /
               cxs ) * collength +
              (ws->y - yp - 3) / (shapes.titlebar_height + 2) : -1;

        if ( (ws->buttons == ws_bt_left || ws->buttons == ws_bt_right)
           && (oldpos != pos ||
               ws->flags != ws_f_none) && ws->x >= xp && ws->x < xp + xs ) {
            if (oldpos >= 0 && oldpos < b->b.d.tag->num_options && oldpos !=
                pos) {
            ...
            if (pos >= 0 && pos < b->b.d.tag->num_options) {
                if ( (num_selected +=
                          (b->b.d.tag->tagged[pos] ^= 1) ? 1 : -1) >
                    b->b.d.tag->max_options && b->b.d.tag->max_options >
                    0 ) {
        ...
        if ( ws->buttons == ws_bt_none && (ws->flags == ws_f_lbutton
                                          || ws->flags == ws_f_rbutton) ) {
            oldpos = -1;
        }
        else {
            oldpos = pos;
        }
    } while ( ws->flags == ws_f_none ||
             (ws->x >= xp && ws->x < xp + xs && ws->y >= yp
             && ws->y < yp + ys) );

    wi_drawbutton(b, 0);

    if (leftright && b->b.d.tag->tag_lroutine) {
        b->b.d.tag->tag_lroutine(&b->b);
    }

    if (!leftright && b->b.d.tag->tag_rroutine) {
        b->b.d.tag->tag_rroutine(&b->b);
    }
                          ...
                          int leftright)
{
    ...
    else if ( p > strlen(buffer) ) {
        p = strlen(buffer);
    }

    do {
        ws_drawline(w_xwinincoord(b->b.w, b->b.xpos) + b->b.d.str->d_xsize +
                    (p - b->b.d.str->offset) * ws_pixstrlen(
                        "M") + 3, w_ywinincoord(b->b.w, b->b.ypos) +
                    shapes.titlebar_height, w_xwinincoord(b->b.w,
                                                          b->b.xpos) +
                    b->b.d.str->d_xsize +
                    (p - b->b.d.str->offset + 1) * ws_pixstrlen("M") + 2,
        ...
        if (ws->flags == ws_f_keypress) {
            switch (ws->key) {
                ...
                case 0x253: /* del */
                    ...
                    if ( p < strlen(buffer) ) {
                        memmove(&buffer[p], &buffer[p + 1], strlen(
                                    buffer) - p);
                    }
                ...
                case 0x8: /* backspace */
                    ...
                    if (p > 0) {
                        memmove(&buffer[p - 1], &buffer[p], strlen(
                                    buffer) - p + 1);

                        if (--p < b->b.d.str->offset) {
                            b->b.d.str->offset = p;
                        }
                    }
                ...
                default:
                    ...
                    if (isprint(ws->key) &&
                        ( b->b.d.str->allowed_char == NULL
                        || b->b.d.str->allowed_char(ws->
                                                    key) ) && p <
                        b->b.d.str->max_length) {
                        if (buffer[p] == 0) {
                            buffer[p + 1] = 0;
                        }
    ...
    if (change) {
        if (leftright) {
            if (b->b.d.str->l_string_entered)               {
                b->b.d.str->l_string_entered(&b->b);
            }
        }
        else {
            if (b->b.d.str->r_string_entered)      {
                b->b.d.str->r_string_entered(&b->b);
            }
        }
