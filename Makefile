...
ifdef GER
CFLAGS=$(GRX_INCLUDES) -std=c99 -Wall -g -DGNU_C -DGO32 -DGER -ansi -pedantic -Wwrite-strings -I wins -I language -c
else
CFLAGS=$(GRX_INCLUDES) -std=c99 -Wall -g -DGNU_C -DGO32 -ansi -pedantic -Wwrite-strings -I wins -I language -c
...
plottxt.o: plottxt.c plottxt.h plotsys.h plotdata.h structs.h
	gcc -I wins -I language -Wall -g -DGNU_C -c plottxt.c -o plottxt.o
title.o: title.c title.h structs.h
	gcc $(GRX_INCLUDES) -I wins -I language -Wall -g -DGNU_C -c title.c -o title.o
lac_cfg.o: lac_cfg.c lac_cfg.h
	gcc -std=c99 -I wins -I language -Wall -g -DGNU_C -c lac_cfg.c -o lac_cfg.o
linux_config.o: linux_config.c linux_config.h
	gcc -std=c99 -I wins -I language -Wall -g -DGNU_C -c linux_config.c -o linux_config.o
