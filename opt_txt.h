...
enum tlw_types {
    tlw_t1, tlw_t2, tlw_anim, tlw_thing, tlw_num
};
struct txt_list_win {
    enum tlw_types type;
    struct w_window *win;
    ...
    *b_m_load, *b_m_save, *b_m_level, *b_m_down, **b_texture;
    ...
    int oldxpos, oldypos, oldxsize, oldysize, offset, maxnum, maxoffset,
        txt_xoffset,
        txt_yoffset, txt_xsize, txt_ysize, dontcalltwice, oldxnumtxt,
        oldynumtxt, oldmode,
...
struct txtwin_savedata {
    int zoom, xpos, ypos, xsize, ysize;
};
