...
int checkd2version(char *path) {
    ...
    if ( ( f = fopen(fname, "rb") ) != NULL ) {
        ...
        printf("Can't find \"%s\" in the Descent 2 directory.\n", fname);
    }
                  ...
                  int *resolution)
{
    ...
    do {
        printf("\n");
        printf(
            "Welcome to Devil " VERSION
            ", the Descent 1 and Descent 2 Editor.\n");
        printf(
            "-----------------------------------------------------------\n");
        ...
        switch (x) {
            case 'A':
                askpath(devilpath, "Devil", "config/devil.ini");
                break;
            ...
            case 'Q':
                ...
                if ( !checkpath(devilpath, "config/devil.ini", "Devil") ) {
                    break;
                }
