...
#define TXT_WRONGBLKHEAD "Datei %s hat den falschen Anfang:\n" \
                         "\"%s\"!=\"DMB_BLOCK_FILE\""
#define TXT_NOCUBEFORFL\
    "Kann WÅrfel %d fÅr flackerndes Licht %d nicht finden."
...
#define TXT_TAGGEDCUBENOPROD\
    "Markiertes Segment %d ist kein Robot-Produzent."
...
#define TXT_POGINVALIDSIZE\
    "Texture %d in Pog-Datei hat Grî·e %d*%d != 64*64."
